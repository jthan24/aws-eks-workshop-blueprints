locals {
  ...
  #---------------------------------------------------------------
  workload_repo = "https://github.com/jthan24/eks-blueprints-workloads.git"
  ...
  tags = {
    ...
    GithubRepo = "github.com/jthan24/aws-eks-workshop-blueprints"
    youtube    = "nomueras en el intento"
    managed    = "terraform"
  }
